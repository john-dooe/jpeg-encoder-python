...
if __name__ == '__main__':
    ...
    parser.add_argument('-l', '--lossless', action="store_true", help='Whether lossless compression is used')
    ...
    if is_grayscale(img):
        ...
        if args.lossless:
            ...
            grayscale_encoder(saved_jpeg_name, img_grayscale, height, width, True)
        else:
            grayscale_encoder(saved_jpeg_name, img_grayscale, height, width, False)
    ...
    # RGB彩色图
        ...
        if args.lossless:
            print('Using lossless compression.')
            color_encoder(saved_jpeg_name, img, height, width, True)
        else:
            color_encoder(saved_jpeg_name, img, height, width, False)
